...
const dbConfig = {
    host: 'b8so2ifbrnlld6wnbchv-mysql.services.clever-cloud.com',
    user: 'uh8f1x8iwrknuaes',
    password: 'CJKZ3SNgWOe2eRgMZCta', // Replace with your MySQL password
    database: 'b8so2ifbrnlld6wnbchv'
};
